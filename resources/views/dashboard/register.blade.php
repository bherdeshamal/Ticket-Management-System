...
<div class="login-body">
    <div class="form-login">
        ...
        <h5 class="login-subtitle">Enter your details to register your account</h5>
</br>
</br>
@if(Session::has('success'))
                            <div class="alert alert-success" > 
        ...
        <form method="post" action="{{route('Ticket-Management-System/register')}}">
        {{ csrf_field() }} 
        ...
        <div class="form-group">
            <label for="cpassword">Confirm Password</label> 
			  <input placeholder="Confirm Password" class="form-control" name="cpassword" type="password" value="">
        </div>
       
        <button type="submit" class="theme-btn">
            Register
        </button>
        <h3>Alreaddy have an account <a href="/Ticket-Management-System/employee-login">Login here ...! </a></h3>
