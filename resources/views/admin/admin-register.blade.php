	...
	<div class="limiter">
		<div class="container-login100" style="background-image:{{asset('login/assets/images/bg-01.jpg')}}";>
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  method="post" action="/Ticket-Management-System/adminregister">
                {{ csrf_field() }}  
					...
					<div class="wrap-input100 validate-input" data-validate = "Choose Support" >
                    </br>
						<select class="form-control" type="text" id="support" name="support">
						
							<option selected="selected" value="">Select</option>
                            
                            @foreach($key as $row)
                            <option value="{{$row['support']}}">{{$row['support']}}</option>
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="/Ticket-Management-System/admin-login"><h5>Already have an account?? > Login<h5></a>
						</a>
					</div>
				</form>
			</div>
